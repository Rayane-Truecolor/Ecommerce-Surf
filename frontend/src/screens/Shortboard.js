...
// Définition d'une fonction composant Shortboard
function Shortboard() {
  ...
  // Rendu du composant Shortboard
  return (
    <div>
      <Helmet>
        <title>Shortboard</title>
      </Helmet>
      <h1>Shortboard</h1>
      <div className="products">
        {loading ? (
          ...
          <Row>
            {products
              .filter((product) => product.category === 'Shortboard')
              .map((product) => (
...
// Exporte la fonction Shortboard comme composant par défaut
